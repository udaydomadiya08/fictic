...
def fast_export(input_clip_or_path, out_path, fps=30, crf=30, preset="medium", pix_fmt="yuv420p", use_hw=True, threads=4):
    """
...
def export_hq(clip, out_path, threads=4, use_hw_final=False):
    """
    ...
    if isinstance(clip, str):
        ...
        cmd = [
            "ffmpeg", "-y", "-i", clip,
            "-c:v", "libx264",
            "-preset", "medium",      # slower but high quality
            "-crf", "21",           # adjust quality (lower = better)
...
def export_temp(clip, out_path):
    return fast_export(clip, out_path, fps=30, crf=21, preset="medium", pix_fmt="yuv420p", use_hw=True, threads=4)
...
if __name__ == "__main__":
    ...
    #to call: python3 fictic18_1.py --input_videos ./input_vid --music ./music --out "out/" --whisper_model tiny 